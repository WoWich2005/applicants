...
namespace bntuapplicants_backend.Data.Interfaces
{
    public interface IEvaluationCriteriaRepository
    {
        ...
        Task<PagedResponse<EvaluationCriteria>> GetPagedAsync(int page, int pageSize, string? search, string? type = null, string? idSearch = null, string? sortField = null, string? sortOrder = null);
