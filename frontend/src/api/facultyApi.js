...
export const facultiesApi = {
  ...
  getPaged: ({ page, pageSize, filters, sortField, sortOrder }) => instance.get(`/faculties/paged`, { params: { page, pageSize, search: filters?.name?.[0], idSearch: filters?.id?.[0], sortField, sortOrder } }),
