...
export const specialtiesApi = {
  ...
  getPaged: ({ page, pageSize, filters, sortField, sortOrder }) => instance.get(`/specialties/paged`, { params: { page, pageSize, search: filters?.name?.[0], facultyId: filters?.facultyId?.[0], departmentId: filters?.departmentId?.[0], sortField, sortOrder } }),
