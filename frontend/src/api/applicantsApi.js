...
export const applicantsApi = {
  ...
  getPaged: ({ page, pageSize, filters, sortField, sortOrder }) => instance.get(`/applicants/paged`, { params: { page, pageSize, search: filters?.name?.[0], externalIdSearch: filters?.externalId?.[0], sortField, sortOrder } }),
