...
export const departmentsApi = {
  ...
  getPaged: ({ page, pageSize, filters, sortField, sortOrder }) => instance.get(`/departments/paged`, { params: { page, pageSize, search: filters?.name?.[0], facultyId: filters?.facultyId?.[0], sortField, sortOrder } }),
