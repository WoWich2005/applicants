...
\src[laws:education] Об образовании: Кодекс Республики Беларусь от 13 января 2011 г. №~243-З~// Эталон [Электронный ресурс].~--~Минск: Национальный центр правовой информации Республики Беларусь, 2024.~--~Режим доступа: \url{https://etalonline.by/}.~--~Дата доступа: 15.05.2026.

\src[laws:admission] Правила приёма лиц для получения высшего образования I~ступени: утв. Указом Президента Республики Беларусь от 27.07.2016~г. №~280 [Электронный ресурс].~--~Режим доступа: \url{https://pravo.by/}.~--~Дата доступа: 15.05.2026.

\src[aspnetcore] Microsoft Corporation. ASP.NET Core documentation [Электронный ресурс].~--~Режим доступа: \url{https://learn.microsoft.com/en-us/aspnet/core/}.~--~Дата доступа: 15.05.2026.
...
\src[react] Meta Platforms~Inc. React documentation [Электронный ресурс].~--~Режим доступа: \url{https://react.dev/}.~--~Дата доступа: 15.05.2026.

\src[antdesign] Ant Design Team. Ant Design~--~A UI Design Language [Электронный ресурс].~--~Режим доступа: \url{https://ant.design/}.~--~Дата доступа: 15.05.2026.

\src[vite] Vite Team. Vite~--~Next Generation Frontend Tooling [Электронный ресурс].~--~Режим доступа: \url{https://vitejs.dev/}.~--~Дата доступа: 15.05.2026.
...
\src[npgsql] Npgsql Project. Npgsql~--~.NET Data Provider for PostgreSQL [Электронный ресурс].~--~Режим доступа: \url{https://www.npgsql.org/}.~--~Дата доступа: 15.05.2026.

\src[liquibase] Liquibase~Inc. Liquibase Documentation [Электронный ресурс].~--~Режим доступа: \url{https://docs.liquibase.com/}.~--~Дата доступа: 15.05.2026.
...
\src[axios] axios contributors. Axios HTTP client documentation [Электронный ресурс].~--~Режим доступа: \url{https://axios-http.com/}.~--~Дата доступа: 15.05.2026.

\src[react-i18next] i18next contributors. react-i18next: Internationalization for React done right [Электронный ресурс].~--~Режим доступа: \url{https://react.i18next.com/}.~--~Дата доступа: 15.05.2026.
...
\src[sanpin1] Гигиенический норматив <<Предельно допустимые уровни нормируемых параметров при работе с видеодисплейными терминалами и электронно-вычислительными машинами>>: утв. постановлением Министерства здравоохранения Республики Беларусь от 28.06.2013 №~59.
...
\src[sn-heating] СН~4.02.03--2019. Отопление, вентиляция и кондиционирование воздуха: утв. постановлением Министерства архитектуры и строительства Республики Беларусь от 16.12.2019 №~57.

\src[sn-evacuation] СН~2.03.05--2020. Эвакуационные пути и выходы: утв. постановлением Министерства архитектуры и строительства Республики Беларусь от 30.10.2020 №~71.
...
\src[sn-fire] СН~2.02.05--2020. Пожарная безопасность зданий и сооружений: утв. постановлением Министерства архитектуры и строительства Республики Беларусь от 12.11.2020 №~79.

\src[sn-light] СН~2.04.03--2020. Естественное и искусственное освещение: утв. постановлением Министерства строительства и архитектуры Республики Беларусь от 30.10.2020 №~70.
